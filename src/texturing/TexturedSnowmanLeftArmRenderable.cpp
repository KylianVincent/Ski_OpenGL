...
TexturedSnowmanLeftArmRenderable::TexturedSnowmanLeftArmRenderable(ShaderProgramPtr shaderProgram, const std::string& armTextureFilename, const DynamicSnowmanPtr& snowman)
...
TexturedSnowmanLeftArmRenderable::~TexturedSnowmanLeftArmRenderable()
{
...
void TexturedSnowmanLeftArmRenderable::do_draw()
{

    glm::mat4 parentTransformation = glm::mat4(1.0);
    glm::mat4 localTransformation = glm::mat4(1.0);
    float rArmAngle = m_snowman->getLeftArmAngle();
...
void TexturedSnowmanLeftArmRenderable::do_animate(float time)
{
}
