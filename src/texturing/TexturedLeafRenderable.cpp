...
TexturedLeafRenderable::TexturedLeafRenderable(ShaderProgramPtr shaderProgram, const std::string&LeafTextureFilename)
          ...
          m_pBuffer(0), m_nBuffer(0), m_tBuffer(0), m_texId(0)
{
    ...
    sf::Image image;
    image.loadFromFile(LeafTextureFilename);
...
TexturedLeafRenderable::~TexturedLeafRenderable()
{
...
void TexturedLeafRenderable::do_draw()
{
    //Locations
...
void TexturedLeafRenderable::do_animate(float time)
{
}

void TexturedLeafRenderable::setMaterial(const MaterialPtr& material)
{
    m_material = material;
}
