...
TexturedSnowmanRightArmRenderable::TexturedSnowmanRightArmRenderable(ShaderProgramPtr shaderProgram, const std::string& armTextureFilename, const DynamicSnowmanPtr& snowman)
          ...
          m_pBuffer(0), m_nBuffer(0), m_tBuffer(0), m_texId(0)
{
    ...
    sf::Image image;
    image.loadFromFile(armTextureFilename);
...
TexturedSnowmanRightArmRenderable::~TexturedSnowmanRightArmRenderable()
{
...
void TexturedSnowmanRightArmRenderable::do_draw()
{

    glm::mat4 parentTransformation = glm::mat4(1.0);
    glm::mat4 localTransformation = glm::mat4(1.0);
    float rArmAngle = m_snowman->getRightArmAngle();
    ...
    setLocalTransform(localTransformation);
...
void TexturedSnowmanRightArmRenderable::do_animate(float time)
{
}
