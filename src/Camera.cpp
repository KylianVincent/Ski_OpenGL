...
Camera::Camera()
    : m_view{ glm::lookAt( glm::vec3{0, 0, -5}, glm::vec3{}, glm::vec3{0,1,0}) },
      m_fov{ 1.04f }, m_ratio{ 1.0f }, m_znear{ 1.0f }, m_zfar{ 550.0f },
...
void Camera::animate(float time, ParticlePtr guidingRenderable)
{
    ...
    setViewMatrix( glm::lookAt(visionAngle, px, glm::vec3( 0, 0, 1 ) ) );
